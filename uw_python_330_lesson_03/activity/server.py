...
class Server(object):
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def __init__(self, port=50000):
        ...
        self.room = 0
        # add coordinates to track location
        self.x = 0
        self.y = 0
    ...
    def room_description(self, room_number):
        ...
        # TODO: YOUR CODE HERE
        # thanks to ChatGPT for the descriptions
        room_descriptions = [
            ("The entry room beckons with its warm ambiance, adorned with ivory walls, "
             "elegant artwork, a grand chandelier casting a gentle glow, a plush rug "
             "inviting relaxation, an antique coat rack, and a subtle scent of fresh flowers, "
             "setting the stage for the journey ahead."),
            ("The kitchen, a bustling hub of culinary creativity, emanates warmth and comfort "
             "with its gleaming stainless steel appliances, inviting granite countertops, "
             "and the aroma of spices mingling in the air."),
            ("The bathroom, a sanctuary of serenity, exudes modern elegance with its sleek marble "
             "countertops, sparkling porcelain fixtures, and the soft glow of recessed lighting, "
             "offering a tranquil retreat from the chaos of the outside world."),
            ("The trophy hallway, a gallery of triumphs, boasts gleaming glass display cases "
             "showcasing an impressive array of trophies, medals, and plaques, each telling "
             "a story of hard-earned victories and cherished memories.")
        ]
    ...
    def get_input(self):
        ...
        # TODO: YOUR CODE HERE
        full_msg = self.client_connection.recv(4096).decode()
        end_of_msg = full_msg.index("\n")
        msg = full_msg[:end_of_msg]
    ...
    def move(self, argument):
        ...
        * "west"
        ...
        pos = (new_x, new_y)
        if pos in valid_rooms.keys():
            self.x = new_x
            self.y = new_y
            self.room = valid_rooms[pos]
    ...
    def route(self):
        ...
        # TODO: YOUR CODE HERE
        routes = {"move": self.move,
                  "quit": self.quit,
                  "say": self.say}
        parsed_input = self.input_buffer.split(" ")
        route = parsed_input[0]
        arg = " ".join(parsed_input[1:])
        routes[route](arg)
        return
    ...
    def push_output(self):
        ...
        # TODO: YOUR CODE HERE
        msg = "OK! " + self.output_buffer + "\n"
        self.client_connection.sendall(msg.encode())
        return
